...
from app.services.export_service import export_board_pptx, export_executive_pdf, export_metrics_excel
...
@router.get("/pptx", dependencies=[Depends(require_any)])
def export_pptx(db: Session = Depends(get_db)):
    data = export_board_pptx(db)
    return Response(data,
                    media_type="application/vnd.openxmlformats-officedocument.presentationml.presentation",
                    headers={"Content-Disposition": "attachment; filename=board-report.pptx"})
